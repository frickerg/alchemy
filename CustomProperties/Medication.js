const medication = [
  {
    ...
    contraindication: "Schwere Leberfunktionsstörung, akute Hepatitis, dekompensierte aktive Lebererkrankung, M. Meulengracht.",
  ...
  },
  {
    ...
    contraindication: "Aktive Magen-Darm-Ulzera, gastrointestinale Blutungen, entzündliche Darmerkrankung, schwere Leberfunktionsstörung, schwere Niereninsuffizienz (Clcr <30 ml/Min.), schwere Herzinsuffizienz (NYHA III-IV), postoperative Schmerzen nach koronarem Bypass oder Einsatz von Herz-Lungen-Maschine. Schwangerschaft (3. Trimenon; 1. und 2. Trimenon «FI»), Stillzeit.",
  ...
  },
  {
    ...
    therapy: "Anxiolytika",
    indication: "Erregungszustände; Angstzustände, Spannungszustände und damit verbundene Schlafstörungen; präoperative Sedation.",
    dosage: "Je nach Schweregrad der Symptomatik, der Dauer der Behandlung und entsprechend dem individuellen Bedarf 1 mg Lorazepam 2-3 mal täglich.",
    contraindication: "Myasthenia gravis, schwere Ateminsuffizienz, Schlafapnoe, schwere Leberinsuffizienz, schwere Niereninsuffizienz, Schock, Kollaps, Koma; akute Alkohol-, Psychopharmaka-, Schlafmittel- oder Schmerzmittelintoxikation; Abhängigkeit. Schwangerschaft, Stillzeit. <12 J.",
  ...
  },
  {
    ...
    indication: "Hypotone Dehydratation, isotone Dehydratation, Hyponatriämie, Hypochlorämie, Flüssigkeitsersatz, kurzfristiger Volumenersatz, Trägerlösung, Unterhalt von venösen Zugängen.",
    dosage: "I.v. Inf.",
  ...
  },
  {
    ...
    indication: "Prophylaxe von Schlaganfall nach TIA, Herzinfarktprophylaxe bei sehr hohem kardiovaskulärem Risiko, Reinfarktprophylaxe; Reokklusionsprophylaxe nach koronarem Bypass, PTCA oder arteriovenösem Shunt bei Dialysepatienten; instabile Angina pectoris, akuter Herzinfarkt, Prophylaxe von arteriellen Thrombosen nach gefässchirurgischen Eingriffen, Prophylaxe von Gefässverschlüssen bei arterieller Verschlusskrankheit.",
    dosage: "Min. 30 Min. vor dem Essen.",
    contraindication: "Hämorrhagische Diathese, Magen-Darm-Ulzera, schwere Leberfunktionsstörungen, schwere Niereninsuffizienz, schwere dekompensierte Herzinsuffizienz, gleichzeitig mit Methotrexat ≥15 mg/Wo. Schwangerschaft (3. Trimenon; 1. und 2. Trimenon «FI»), Stillzeit (Dosen >300 mg tgl.).",
  ...
  },
  {
    ...
    therapy: "Analgetika/Antiphlogistika/Antirheumatika",
    indication: "Leichte bis mässig starke Schmerzen, Schmerzen und/oder Fieber bei Erkältungskrankheiten. 12–18 J.: 2. Wahl und nur auf ärztliche Verschreibung.",
    dosage: "Nicht nüchtern einnehmen. Als Selbstmedikation während max. 3 Tagen.",
    contraindication: "Hämorrhagische Diathese, aktive Magen-Darm-Ulzera, gastrointestinale Blutung, entzündliche Darmerkrankung, schwere Leberfunktionsstörung, schwere Niereninsuffizienz (Clcr <30 ml/Min.), schwere Herzinsuffizienz (NYHA III-IV), gleichzeitig mit Methotrexat ≥15 mg/Wo., postoperative Schmerzen nach koronarem Bypass oder Einsatz von Herz-Lungen-Maschine. Schwangerschaft (3. Trimenon; 1. und 2. Trimenon «FI»), Stillzeit.",
  ...
  },
  {
    ...
    contraindication: "Myasthenia gravis, schwere Ateminsuffizienz, Schlafapnoe, schwere Leberinsuffizienz, gleichzeitig mit HIV-Protease-Inhibitoren oder Azol-Antimykotika. Schwangerschaft (1. Trimenon; 2. und 3. Trimenon «FI»), Stillzeit.",
